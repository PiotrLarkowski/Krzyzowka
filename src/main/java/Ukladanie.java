...
//            KrzyzowkaRysowanie.lWIadomosc1.setText("");
            ...
            for (int i = 0; ; i++) {
                ...
                if (sec < 10) {
                    if (min < 10) {
                        KrzyzowkaRysowanie.lWIadomosc2.setText("Czas wykonywania: " + hour + ":0" + min + ":0" + sec);
                    } else {
                        KrzyzowkaRysowanie.lWIadomosc2.setText("Czas wykonywania: " + hour + ":" + min + ":0" + sec);
                    }
                } else {
                    if (min < 10) {
                        KrzyzowkaRysowanie.lWIadomosc2.setText("Czas wykonywania: " + hour + ":0" + min + ":" + sec);
                    } else {
...
//    public static void usupelnianiePasujacychSlow() {
//        wybraneSlowaDoKrzyzowki[0]="PIWONIA";
//        wybraneSlowaDoKrzyzowki[1]="PROCH";
//        wybraneSlowaDoKrzyzowki[2]="WIGOR";
//        wybraneSlowaDoKrzyzowki[3]="ODGŁOSY";
//        wybraneSlowaDoKrzyzowki[4]="NIOBE";
//        wybraneSlowaDoKrzyzowki[5]="HERMES";
//        wybraneSlowaDoKrzyzowki[6]="AZYL";
//        wybraneSlowaDoKrzyzowki[7]="ZASPA";
//        wybraneSlowaDoKrzyzowki[8]="LOTKI";
//        wybraneSlowaDoKrzyzowki[9]="OSET";
//        wybraneSlowaDoKrzyzowki[10]="ZAWIADOMIENIE";
//        wybraneSlowaDoKrzyzowki[11]="ZYGFRYD";
//        wybraneSlowaDoKrzyzowki[12]="WODOLOT";
//        wybraneSlowaDoKrzyzowki[13]="GODET";
//        wybraneSlowaDoKrzyzowki[14]="ASTENIK";
//        wybraneSlowaDoKrzyzowki[15]="RULON";
//        wybraneSlowaDoKrzyzowki[16]="DOTYK";
//        wybraneSlowaDoKrzyzowki[17]="OBRACAK";
//        wybraneSlowaDoKrzyzowki[18]="ETA";
//        wybraneSlowaDoKrzyzowki[19]="IDA";
//        wybraneSlowaDoKrzyzowki[20]="OTRANTO";
//        wybraneSlowaDoKrzyzowki[21]="ENNIO";
//        wybraneSlowaDoKrzyzowki[22]="KNEDLE";
//        wybraneSlowaDoKrzyzowki[23]="MYDŁO";
//        wybraneSlowaDoKrzyzowki[24]="SKECZ";
//        wybraneSlowaDoKrzyzowki[25]="KORUNK";
//        wybraneSlowaDoKrzyzowki[26]="CYNIZM";
//        wybraneSlowaDoKrzyzowki[27]="DOBOSZ";
//        wybraneSlowaDoKrzyzowki[28]="DROZD";
//        wybraneSlowaDoKrzyzowki[29]="ODBLASK";
//        wybraneSlowaDoKrzyzowki[30]="BABKA";
//        wybraneSlowaDoKrzyzowki[31]="DIALIZA";
//        wybraneSlowaDoKrzyzowki[32]="SUAZI";
//        wybraneSlowaDoKrzyzowki[33]="SKRA";
//        wybraneSlowaDoKrzyzowki[34]="SOPLE";
//        wybraneSlowaDoKrzyzowki[35]="PUZO";
//        wybraneSlowaDoKrzyzowki[36]="RÓZGI";
//    }
}
...
class POJOArrayList {
    ...
    public POJOArrayList() {
        ...
        word25.addAll(new ArrayList<>(Arrays.asList(5, 5, 6, 6, 0, 5, 26, 6, 1, 0, 23, 6, 2, 5, 27, 6, 3, 0, 28, 6, 4, 5)));
        ...
        word28.addAll(new ArrayList<>(Arrays.asList(6, 6, 29, 5, 0, 0, 22, 5, 1, 4, 31, 5, 2, 0, 24, 5, 3, 4, 33, 5, 4, 0, 25, 5, 5, 4)));
        ...
        word32.addAll(new ArrayList<>(Arrays.asList(7, 4, 29, 5, 0, 4, 31, 5, 2, 4, 33, 5, 4, 4, 34, 4, 6, 3)));
